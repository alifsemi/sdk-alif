...
SHELL_STATIC_SUBCMD_SET_CREATE(
	...
	SHELL_CMD_ARG(pm_standby, NULL, "Start Standby-state sequency  --period", cmd_standby_test, 1, 10),
	SHELL_CMD_ARG(pm_idle, NULL, "Start Standby-state sequency  --period", cmd_idle_test, 1, 10),
	#endif
