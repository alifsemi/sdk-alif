...
void write_rgb888_to_rgb565_buf(int width, int height, const uint8_t *restrict src_ptr,
				uint16_t *restrict dst_ptr)
{
	...
	for (int y = 0; y < height; y++) {
		...
		for (int x = 0; x < width; x += 16) {
			...
			uint8x16x2_t out = {vsriq(vshlq_n_u8(g, 3), b, 3), vsriq(r, g, 5)};
		...
		for (int x = 0; x < width; x += 4) {
			...
			*dstp32++ =
				(r1b0g0r0 & 0xf8000000) | ((g2r2b1g1 << 19) & 0x07e00000) |
				((g2r2b1g1 << 5) & 0x001f0000) | ((r1b0g0r0 << 8) & 0x0000f800) |
				((r1b0g0r0 >> 5) & 0x000007e0) | ((r1b0g0r0 >> 19) & 0x0000001f);
			*dstp32++ =
				((b3g3r3b2 << 16) & 0xf8000000) | ((b3g3r3b2 << 3) & 0x07e00000) |
				((b3g3r3b2 >> 11) & 0x001f0000) | ((g2r2b1g1 >> 8) & 0x0000f800) |
				((g2r2b1g1 >> 21) & 0x000007e0) | ((b3g3r3b2 >> 3) & 0x0000001f);
		}
#else
