 ...
 *
 * Static input data for Keyword Spotting CNN Small INT8 model
 * Input shape: [1, 490] - MFCC features for audio sample
 */
...
__aligned(4) static const uint8_t kws_input_data[]
__attribute__((section(".rodata.kws_input"))) = {
