...
- **Minor upstream changes**: Works regardless of minor upstream ExecutorTorch changes
...
**Note:** Major API changes in upstream ExecutorTorch may require updating these
