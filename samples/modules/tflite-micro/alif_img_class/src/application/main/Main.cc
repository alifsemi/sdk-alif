...
static int app_set_video(void)
{
	/* Enable MIPI CSI controller halt function when FIFO
	 * is almost full. */
	sys_write32(sys_read32(0x49030010) | BIT(1), 0x49030010);
...
SYS_INIT(app_set_video, POST_KERNEL, 90);