...
This is an example single-LUN configuration that uses a RAM-based disk without
any file system. It needs an additional 96 KiB RAM for the RAM-disk and is
intended for testing the USB mass storage class implementation.
