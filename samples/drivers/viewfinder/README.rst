...
For E7 with ARX3A0 (no ISP)::

   west build -b <board> -- \
     -DDTC_OVERLAY_FILE=boards/arx3a0_mipi_viewfinder.overlay

For E8 with ARX3A0 and ISP::

   west build -b <board> -- \
     -DDTC_OVERLAY_FILE=boards/arx3a0_mipi_isp_viewfinder.overlay \
     -DOVERLAY_CONFIG=boards/isp.conf

For E7 with MT9M114 (no ISP)::

   west build -b <board> -- \
     -DDTC_OVERLAY_FILE=boards/mt9m114_mipi_viewfinder.overlay \
     -DOVERLAY_CONFIG=boards/serial_camera_mt9m114.conf

For E8 with MT9M114 and ISP::
