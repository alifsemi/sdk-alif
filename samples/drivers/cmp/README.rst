...
.. note::
   ...
   - **LPCMP functionality is not supported** on `alif_e7_dk_rtss_hp` and `alif_e7_dk_rtss_he` boards due to unavailable pinouts.
     The console output below is for **CMP only**.
