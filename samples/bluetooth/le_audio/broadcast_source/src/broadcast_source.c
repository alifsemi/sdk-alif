...
static int audio_datapath_init(void)
{
	...
	audio_encoder = audio_encoder_create(
		CONFIG_ALIF_BLE_AUDIO_FS_HZ, encoder_stack, CONFIG_LC3_ENCODER_STACK_SIZE, queues,
		ARRAY_SIZE(queues), audio_queue, CONFIG_ALIF_LC3_FRAME_DURATION_STATIC_CONFIG);
