...
notifications so a client can track hearing aid type changes.  The Hearing
Access Service UUID (0x1854) is included in the advertising payload so PTS and
other conformance tools can discover the device.  HAS bond data
