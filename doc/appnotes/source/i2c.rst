...
The I2C driver supports operation in 10-bit address mode also. The steps below describe how to configure and enable this mode.
...
Build an I2C Application with Zephyr
=====================================

Follow these steps to build the I2C sample application using the Alif Zephyr
SDK:
