...
pins when they are not used by other peripherals (like UART, I2C, etc.). GPIO module can be used for tasks like lighting LEDs or reading the state of push-buttons, switches, etc. The GPIO module also offers switch contact debounce and interrupt capabilities.

The device includes up to nineteen GPIO modules with support of up to 144 I/O pins in total.
