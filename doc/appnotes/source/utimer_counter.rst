...
The alarm runs before entering ``RUNTIME_IDLE`` and again after
``SUSPEND_TO_IDLE``, S2RAM STANDBY, and S2RAM STOP so that the counter
value can be verified. The wake source is RTC on the HE
core or LPTIMER0 on the HP core, not the UTIMER under test.
...
``alif_e7_dk/ae722f80f55d5xx/rtss_hp`` as applicable. The same PM sample can
also be used with the supported ``alif_b1_dk`` and ``alif_e1c_dk`` boards.
The TCM snippet is supported only on the HE core.
...
.. code-block:: console
   ...
   *** Booting Zephyr OS build ***
   [00:00:00.001,000] <inf> counter_pm: alif_e8_dk (S2RAM): counter PM demo (RUNTIME_IDLE, SUSPEND_TO_IDLE, S2RAM STANDBY, S2RAM STOP)
   [00:00:00.001,000] <inf> counter_pm: POWER STATE SEQUENCE:
   [00:00:00.001,000] <inf> counter_pm:   1. PM_STATE_RUNTIME_IDLE
   [00:00:00.001,000] <inf> counter_pm:   2. PM_STATE_SUSPEND_TO_IDLE
   [00:00:00.001,000] <inf> counter_pm:   3. PM_STATE_SUSPEND_TO_RAM (substate 0: STANDBY)
   [00:00:00.001,000] <inf> counter_pm:   4. PM_STATE_SUSPEND_TO_RAM (substate 1: STOP)
   [00:00:00.001,000] <inf> counter_pm: === before RUNTIME_IDLE: counter alarm ===
   [00:00:02.001,000] <inf> counter_pm: counter value: 800004260
   [00:00:02.001,000] <inf> counter_pm: Enter RUNTIME_IDLE sleep for (18000000 microseconds)
   [00:00:20.002,000] <inf> counter_pm: Exited from RUNTIME_IDLE sleep
   [00:00:20.002,000] <inf> counter_pm: Enter PM_STATE_SUSPEND_TO_IDLE for (10000 microseconds)
   [00:00:20.003,000] <inf> counter_pm: PM enter: SUSPEND_TO_IDLE (substate 0)
   [00:00:20.003,000] <inf> counter_pm: PM exit:  SUSPEND_TO_IDLE (substate 0)
   [00:00:20.013,000] <inf> counter_pm: === after SUSPEND_TO_IDLE: counter alarm ===
   [00:00:22.013,000] <inf> counter_pm: counter value: 1600008520
   [00:00:22.013,000] <inf> counter_pm: Enter PM_STATE_SUSPEND_TO_RAM (substate 0: STANDBY) for (6000000 microseconds)
   [00:00:22.014,000] <inf> counter_pm: PM enter: SUSPEND_TO_IDLE (substate 0)
   [00:00:22.014,000] <inf> counter_pm: PM exit:  SUSPEND_TO_IDLE (substate 0)
   [00:00:22.083,000] <inf> counter_pm: PM enter: SUSPEND_TO_RAM (substate 0)
   [00:00:22.083,000] <inf> counter_pm: PM wakeup: SUSPEND_TO_RAM (substate 0)
   [00:00:22.083,000] <inf> counter_pm: PM exit:  SUSPEND_TO_RAM (substate 0)
   [00:00:28.038,000] <inf> counter_pm: === Resumed from PM_STATE_SUSPEND_TO_RAM (substate 0: STANDBY) ===
   [00:00:28.038,000] <inf> counter_pm: === after S2RAM STANDBY: counter alarm ===
   [00:00:30.038,000] <inf> counter_pm: counter value: 2400012780
   [00:00:30.038,000] <inf> counter_pm: Enter PM_STATE_SUSPEND_TO_RAM (substate 1: STOP) for (9000000 microseconds)
   [00:00:30.040,000] <inf> counter_pm: PM enter: SUSPEND_TO_IDLE (substate 0)
   [00:00:30.040,000] <inf> counter_pm: PM exit:  SUSPEND_TO_IDLE (substate 0)
   [00:00:30.108,000] <inf> counter_pm: PM enter: SUSPEND_TO_RAM (substate 1)
   [00:00:30.108,000] <inf> counter_pm: PM wakeup: SUSPEND_TO_RAM (substate 1)
   [00:00:30.108,000] <inf> counter_pm: PM exit:  SUSPEND_TO_RAM (substate 1)
   [00:00:39.056,000] <inf> counter_pm: === Resumed from PM_STATE_SUSPEND_TO_RAM (substate 1: STOP) ===
   [00:00:39.056,000] <inf> counter_pm: === after S2RAM STOP: counter alarm ===
   [00:00:41.056,000] <inf> counter_pm: counter value: 800004260
   [00:00:41.056,000] <inf> counter_pm: === COUNTER PM SEQUENCE COMPLETED ===
