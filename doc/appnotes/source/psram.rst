...
The Infineon S80KS HyperRAM is connected over OSPI1. This configuration was
tested on the Alif E8 CSP engineering board, built with the Alif E8 DevKit
(``alif_e8_dk``) target.
...
``spi_psram`` sample and the MEMC OSPI path. On the Alif E8 engineering
board, S80KS is connected to OSPI1 SS0, with an XIP window at
...
.. list-table::
   ...
   * - S80KS HyperRAM
     ...
     - OSPI1 SS0
     - ``alif_hex_s80ks.overlay`` (E8 CSP engineering board; build with
       the E8 DevKit target)
...
.. note::
   ...
   Infineon S80KS HyperRAM is tested on the **Alif E8 CSP engineering board**
   using the **Alif E8 DevKit** build target.
...
S80KS HyperRAM (E8 engineering board)
-------------------------------------

The ``alif_hex_s80ks.overlay`` file provides the devicetree configuration
for the Infineon S80KS HyperRAM.

On the Alif E8 engineering board, S80KS is connected over OSPI1, but the
sample is still built using the Alif E8 DevKit board target.
