 ...
 */
INLINE void aipl_mve_ldr_4px_argb8888(uint32x4_t *dst, const uint32_t *src, mve_pred16_t pred)
{
 ...
 * @param pred  vector predicate
 */
INLINE void aipl_mve_ldr_8px_argb8888(aipl_mve_argb_x8_t *dst, const uint8_t *src,
				      mve_pred16_t pred)
{
 ...
 * @param pred  vector predicate
 */
INLINE void aipl_mve_ldr_8px_xrgb8888(aipl_mve_rgb_x8_t *dst, const uint8_t *src, mve_pred16_t pred)
{
	dst->b = vldrbq_gather_offset_z(src, AIPL_4_BYTE_OFFSETS_U16, pred);
	dst->g = vldrbq_gather_offset_z(src + 1, AIPL_4_BYTE_OFFSETS_U16, pred);
	dst->r = vldrbq_gather_offset_z(src + 2, AIPL_4_BYTE_OFFSETS_U16, pred);
 ...
 * @param pred      vector predicate
 */
INLINE void aipl_mve_ldr_8px_offset_xrgb8888(aipl_mve_rgb_x8_t *dst, const uint8_t *src,
					     uint8_t offset, mve_pred16_t pred)
{
 ...
 * @param pred  vector predicate
 */
INLINE void aipl_mve_ldr_16px_xrgb8888(aipl_mve_rgb_x16_t *dst, const uint8_t *src,
				       mve_pred16_t pred)
{
 ...
 * @param src   source pointer
 */
INLINE void aipl_mve_ldr_16px_argb8888_uncut(aipl_mve_argb_x16_t *dst, const uint8_t *src)
{
 ...
 * @param src   source pointer
 */
INLINE void aipl_mve_ldr_16px_xrgb8888_uncut(aipl_mve_rgb_x16_t *dst, const uint8_t *src)
{
	uint8x16x4_t argb = vld4q(src);
 ...
 * @param pred  vector predicate
 */
INLINE void aipl_mve_ldr_16px_argb8888(aipl_mve_argb_x16_t *dst, const uint8_t *src,
				       mve_pred16_t pred)
{
	dst->b = vldrbq_gather_offset_z(src, AIPL_4_BYTE_OFFSETS_U8, pred);
	dst->g = vldrbq_gather_offset_z(src + 1, AIPL_4_BYTE_OFFSETS_U8, pred);
 ...
 */
INLINE void aipl_mve_cnvt_4px_argb8888_to_rgba8888(uint32x4_t *dst, uint32x4_t src)
{
 ...
 * @param src   source pixel vector
 */
INLINE void aipl_mve_cnvt_8px_xrgb8888_to_yuv_y(uint16x8_t *dst, aipl_mve_rgb_x8_t src)
{
 ...
 * @param src   source pixel vector
 */
INLINE void aipl_mve_cnvt_16px_xrgb8888_to_yuv_y(uint8x16_t *dst, aipl_mve_rgb_x16_t src)
{
 ...
 * @param src   source pixel vector
 */
INLINE void aipl_mve_cnvt_8px_xrgb8888_to_yuv_u(uint16x8_t *dst, aipl_mve_rgb_x8_t src)
{
 ...
 * @param src   source pixel vector
 */
INLINE void aipl_mve_cnvt_16px_xrgb8888_to_yuv_u(uint8x16_t *dst, aipl_mve_rgb_x16_t src)
{
	aipl_mve_rgb_x8_t t, b;
 ...
 * @param src   source pixel vector
 */
INLINE void aipl_mve_cnvt_8px_xrgb8888_to_yuv_v(uint16x8_t *dst, aipl_mve_rgb_x8_t src)
{
 ...
 * @param src   source pixel vector
 */
INLINE void aipl_mve_cnvt_16px_xrgb8888_to_yuv_v(uint8x16_t *dst, aipl_mve_rgb_x16_t src)
{
	aipl_mve_rgb_x8_t t, b;
 ...
 * @param pred  vector predicate
 */
INLINE void aipl_mve_str_4px_argb8888(uint32_t *dst, uint32x4_t src, mve_pred16_t pred)
{
 ...
 * @param pred  vector predicate
 */
INLINE void aipl_mve_str_8px_argb8888(uint8_t *dst, aipl_mve_argb_x8_t src, mve_pred16_t pred)
{
 ...
 * @param pred  vector predicate
 */
INLINE void aipl_mve_str_16px_xrgb8888(uint8_t *dst, aipl_mve_rgb_x16_t src, mve_pred16_t pred)
{
 ...
 * @param pred  vector predicate
 */
INLINE void aipl_mve_str_16px_argb8888_uncut(uint8_t *dst, aipl_mve_argb_x16_t src)
{
 ...
 * @param pred  vector predicate
 */
INLINE void aipl_mve_str_16px_xrgb8888_uncut(uint8_t *dst, aipl_mve_rgb_x16_t src)
{
 ...
 * @param pred  vector predicate
 */
INLINE void aipl_mve_str_16px_argb8888(uint8_t *dst, aipl_mve_argb_x16_t src, mve_pred16_t pred)
{
	vstrbq_scatter_offset_p(dst, AIPL_4_BYTE_OFFSETS_U8, src.b, pred);
	vstrbq_scatter_offset_p(dst + 1, AIPL_4_BYTE_OFFSETS_U8, src.g, pred);
	vstrbq_scatter_offset_p(dst + 2, AIPL_4_BYTE_OFFSETS_U8, src.r, pred);
 ...
 * @param pred      vector predicate
 */
INLINE void aipl_mve_ldr_8px_offset_argb4444(uint16x8_t *dst, const uint16_t *src, uint8_t offset,
					     mve_pred16_t pred)
{
 ...
 * @param pred      vector predicate
 */
INLINE void aipl_mve_ldr_8px_extend_argb4444(aipl_mve_argb_x8_t *dst, const uint16_t *src,
					     mve_pred16_t pred)
{
 ...
 * @param pred  vector predicate
 */
INLINE void aipl_mve_ldr_8px_argb4444(uint16x8_t *dst, const uint16_t *src, mve_pred16_t pred)
{
 ...
 * @param pred  vector predicate
 */
INLINE void aipl_mve_ldr_16px_xrgb4444(aipl_mve_rgb_x16_t *dst, const uint16_t *src,
				       mve_pred16_t pred)
{
 ...
 * @param pred  vector predicate
 */
INLINE void aipl_mve_ldr_16px_argb4444(aipl_mve_argb_x16_t *dst, const uint16_t *src,
				       mve_pred16_t pred)
{
	uint8x16_t gb = vldrbq_gather_offset_z((uint8_t *)src, AIPL_2_BYTE_OFFSETS_U8, pred);
	uint8x16_t ar = vldrbq_gather_offset_z((uint8_t *)src + 1, AIPL_2_BYTE_OFFSETS_U8, pred);
 ...
 * @param src   source pixel vectors
 */
INLINE void aipl_mve_ldr_16px_argb4444_uncut(aipl_mve_argb_x16_t *dst, const uint16_t *src)
{
 ...
 * @param src   source pixel vectors
 */
INLINE void aipl_mve_ldr_16px_xrgb4444_uncut(aipl_mve_rgb_x16_t *dst, const uint16_t *src)
{
	uint8x16x2_t argb = vld2q((const uint8_t *)src);
 ...
 * @param src   source pixel vector
 */
INLINE void aipl_mve_cnvt_8px_argb4444_to_rgba4444(uint16x8_t *dst, uint16x8_t src)
{
	*dst = vshrq(src, 12);
	*dst = vsliq(*dst, src, 4);
}
 ...
 * @param src   source pixel vector
 */
INLINE void aipl_mve_cnvt_8px_argb4444_to_yuv_y(uint16x8_t *dst, uint16x8_t src)
{
 ...
 * @param src   source pixel vector
 */
INLINE void aipl_mve_cnvt_8px_argb4444_to_yuv_uv(uint16x8_t *u_dst, uint16x8_t *v_dst,
						 uint16x8_t src)
{
	uint16x8_t r = vandq(vshrq(src, 8), vdupq_n_u16(0x000f));
	uint16x8_t g = vandq(vshrq(src, 4), vdupq_n_u16(0x000f));
 ...
 * @param src   source pixel vector
 */
INLINE void aipl_mve_cnvt_8px_argb4444_to_yuv(uint16x8_t *y_dst, uint16x8_t *u_dst,
					      uint16x8_t *v_dst, uint16x8_t src)
{
	uint16x8_t r = vandq(vshrq(src, 8), vdupq_n_u16(0x000f));
	uint16x8_t g = vandq(vshrq(src, 4), vdupq_n_u16(0x000f));
	uint16x8_t b = vandq(src, vdupq_n_u16(0x000f));
 ...
 * @param pred  vector predicate
 */
INLINE void aipl_mve_str_8px_argb4444(uint16_t *dst, uint16x8_t src, mve_pred16_t pred)
{
 ...
 * @param pred  vector predicate
 */
INLINE void aipl_mve_str_8px_extended_argb4444(uint16_t *dst, aipl_mve_argb_x8_t src,
					       mve_pred16_t pred)
{
 ...
 * @param pred  vector predicate
 */
INLINE void aipl_mve_str_16px_argb4444(uint16_t *dst, aipl_mve_argb_x16_t src, mve_pred16_t pred)
{
 ...
 * @param src   source pixel vectors
 */
INLINE void aipl_mve_str_16px_argb4444_uncut(uint16_t *dst, aipl_mve_argb_x16_t src)
{
 ...
 * @param pred  vector predicate
 */
INLINE void aipl_mve_str_16px_xrgb4444(uint16_t *dst, aipl_mve_rgb_x16_t src, mve_pred16_t pred)
{
 ...
 * @param src   source pixel vectors
 */
INLINE void aipl_mve_str_16px_xrgb4444_uncut(uint16_t *dst, aipl_mve_rgb_x16_t src)
{
 ...
 * @param pred      vector predicate
 */
INLINE void aipl_mve_ldr_8px_offset_argb1555(uint16x8_t *dst, const uint16_t *src, uint8_t offset,
					     mve_pred16_t pred)
{
	*dst = vldrhq_gather_offset_z(src, AIPL_OFFSETS_U16(offset, 2), pred);
}
 ...
 * @param pred  vector predicate
 */
INLINE void aipl_mve_ldr_8px_argb1555(uint16x8_t *dst, const uint16_t *src, mve_pred16_t pred)
{
	*dst = vldrhq_z_u16(src, pred);
}
 ...
 * @param pred  vector predicate
 */
INLINE void aipl_mve_ldr_16px_xrgb1555(aipl_mve_rgb_x16_t *dst, const uint16_t *src,
				       mve_pred16_t pred)
{
 ...
 * @param pred  vector predicate
 */
INLINE void aipl_mve_ldr_16px_argb1555(aipl_mve_argb_x16_t *dst, const uint16_t *src,
				       mve_pred16_t pred)
{
	uint8x16_t lower = vldrbq_gather_offset_z((uint8_t *)src, AIPL_2_BYTE_OFFSETS_U8, pred);
	uint8x16_t upper = vldrbq_gather_offset_z((uint8_t *)src + 1, AIPL_2_BYTE_OFFSETS_U8, pred);
 ...
 * @param src   source pixel vectors
 */
INLINE void aipl_mve_ldr_16px_argb1555_uncut(aipl_mve_argb_x16_t *dst, const uint16_t *src)
{
	uint8x16x2_t argb = vld2q((const uint8_t *)src);
 ...
 * @param src   source pixel vectors
 */
INLINE void aipl_mve_ldr_16px_xrgb1555_uncut(aipl_mve_rgb_x16_t *dst, const uint16_t *src)
{
	uint8x16x2_t argb = vld2q((const uint8_t *)src);
 ...
 * @param src   source pixel vector
 */
INLINE void aipl_mve_cnvt_8px_argb1555_to_yuv_y(uint16x8_t *dst, uint16x8_t src)
{
 ...
 * @param src   source pixel vector
 */
INLINE void aipl_mve_cnvt_8px_argb1555_to_yuv_uv(uint16x8_t *u_dst, uint16x8_t *v_dst,
						 uint16x8_t src)
{
	uint16x8_t r = vandq(vshrq(src, 10), vdupq_n_u16(0x001f));
	uint16x8_t g = vandq(vshrq(src, 5), vdupq_n_u16(0x001f));
 ...
 * @param src   source pixel vector
 */
INLINE void aipl_mve_cnvt_8px_argb1555_to_yuv(uint16x8_t *y_dst, uint16x8_t *u_dst,
					      uint16x8_t *v_dst, uint16x8_t src)
{
	uint16x8_t r = vandq(vshrq(src, 10), vdupq_n_u16(0x001f));
	uint16x8_t g = vandq(vshrq(src, 5), vdupq_n_u16(0x001f));
 ...
 * @param pred  vector predicate
 */
INLINE void aipl_mve_str_8px_argb1555(uint16_t *dst, uint16x8_t src, mve_pred16_t pred)
{
	vstrhq_p(dst, src, pred);
}
 ...
 * @param pred  vector predicate
 */
INLINE void aipl_mve_str_16px_xrgb1555(uint16_t *dst, aipl_mve_rgb_x16_t src, mve_pred16_t pred)
{
 ...
 * @param pred  vector predicate
 */
INLINE void aipl_mve_str_16px_argb1555(uint16_t *dst, aipl_mve_argb_x16_t src, mve_pred16_t pred)
{
 ...
 * @param src   source pixel vectors
 */
INLINE void aipl_mve_str_16px_xrgb1555_uncut(uint16_t *dst, aipl_mve_rgb_x16_t src)
{
 ...
 * @param src   source pixel vectors
 */
INLINE void aipl_mve_str_16px_argb1555_uncut(uint16_t *dst, aipl_mve_argb_x16_t src)
{
 ...
 * @param pred  vector predicate
 */
INLINE void aipl_mve_ldr_4px_rgba8888(uint32x4_t *dst, const uint32_t *src, mve_pred16_t pred)
{
	*dst = vld1q_z(src, pred);
}
 ...
 * @param pred  vector predicate
 */
INLINE void aipl_mve_ldr_8px_rgba8888(aipl_mve_argb_x8_t *dst, const uint8_t *src,
				      mve_pred16_t pred)
{
 ...
 * @param pred  vector predicate
 */
INLINE void aipl_mve_ldr_8px_rgbx8888(aipl_mve_rgb_x8_t *dst, const uint8_t *src, mve_pred16_t pred)
{
	dst->b = vldrbq_gather_offset_z(src + 1, AIPL_4_BYTE_OFFSETS_U16, pred);
	dst->g = vldrbq_gather_offset_z(src + 2, AIPL_4_BYTE_OFFSETS_U16, pred);
	dst->r = vldrbq_gather_offset_z(src + 3, AIPL_4_BYTE_OFFSETS_U16, pred);
 ...
 * @param pred      vector predicate
 */
INLINE void aipl_mve_ldr_8px_offset_rgbx8888(aipl_mve_rgb_x8_t *dst, const uint8_t *src,
					     uint8_t offset, mve_pred16_t pred)
{
 ...
 * @param pred  vector predicate
 */
INLINE void aipl_mve_ldr_16px_rgbx8888(aipl_mve_rgb_x16_t *dst, const uint8_t *src,
				       mve_pred16_t pred)
{
 ...
 * @param pred  vector predicate
 */
INLINE void aipl_mve_ldr_16px_rgba8888(aipl_mve_argb_x16_t *dst, const uint8_t *src,
				       mve_pred16_t pred)
{
 ...
 * @param src   source pointer
 */
INLINE void aipl_mve_ldr_16px_rgba8888_uncut(aipl_mve_argb_x16_t *dst, const uint8_t *src)
{
 ...
 * @param src   source pointer
 */
INLINE void aipl_mve_ldr_16px_rgbx8888_uncut(aipl_mve_rgb_x16_t *dst, const uint8_t *src)
{
	uint8x16x4_t rgba = vld4q(src);
 ...
 * @param src   source pixel vector
 */
INLINE void aipl_mve_cnvt_4px_rgba8888_to_argb8888(uint32x4_t *dst, uint32x4_t src)
{
 ...
 * @param src   source pixel vector
 */
INLINE void aipl_mve_cnvt_8px_rgbx8888_to_yuv_y(uint16x8_t *dst, aipl_mve_rgb_x8_t src)
{
 ...
 * @param src   source pixel vector
 */
INLINE void aipl_mve_cnvt_8px_rgbx8888_to_yuv_u(uint16x8_t *dst, aipl_mve_rgb_x8_t src)
{
 ...
 * @param src   source pixel vector
 */
INLINE void aipl_mve_cnvt_8px_rgbx8888_to_yuv_v(uint16x8_t *dst, aipl_mve_rgb_x8_t src)
{
 ...
 * @param pred  vector predicate
 */
INLINE void aipl_mve_str_4px_rgba8888(uint32_t *dst, uint32x4_t src, mve_pred16_t pred)
{
	vst1q_p(dst, src, pred);
}
 ...
 * @param pred  vector predicate
 */
INLINE void aipl_mve_str_8px_rgba8888(uint8_t *dst, aipl_mve_argb_x8_t src, mve_pred16_t pred)
{
 ...
 * @param pred  vector predicate
 */
INLINE void aipl_mve_str_16px_rgbx8888(uint8_t *dst, aipl_mve_rgb_x16_t src, mve_pred16_t pred)
{
 ...
 * @param pred  vector predicate
 */
INLINE void aipl_mve_str_16px_rgba8888(uint8_t *dst, aipl_mve_argb_x16_t src, mve_pred16_t pred)
{
 ...
 * @param src   source pixel vectors
 */
INLINE void aipl_mve_str_16px_rgba8888_uncut(uint8_t *dst, aipl_mve_argb_x16_t src)
{
 ...
 * @param src   source pixel vectors
 */
INLINE void aipl_mve_str_16px_rgbx8888_uncut(uint8_t *dst, aipl_mve_rgb_x16_t src)
{
 ...
 * @param pred      vector predicate
 */
INLINE void aipl_mve_ldr_8px_offset_rgba4444(uint16x8_t *dst, const uint16_t *src, uint8_t offset,
					     mve_pred16_t pred)
{
	*dst = vldrhq_gather_offset_z(src, AIPL_OFFSETS_U16(offset, 2), pred);
}
 ...
 * @param pred  vector predicate
 */
INLINE void aipl_mve_ldr_8px_rgba4444(uint16x8_t *dst, const uint16_t *src, mve_pred16_t pred)
{
	*dst = vldrhq_z_u16(src, pred);
}
 ...
 * @param pred      vector predicate
 */
INLINE void aipl_mve_ldr_8px_extend_rgba4444(aipl_mve_argb_x8_t *dst, const uint16_t *src,
					     mve_pred16_t pred)
{
 ...
 * @param pred  vector predicate
 */
INLINE void aipl_mve_ldr_16px_rgbx4444(aipl_mve_rgb_x16_t *dst, const uint16_t *src,
				       mve_pred16_t pred)
{
 ...
 * @param pred  vector predicate
 */
INLINE void aipl_mve_ldr_16px_rgba4444(aipl_mve_argb_x16_t *dst, const uint16_t *src,
				       mve_pred16_t pred)
{
	uint8x16_t ba = vldrbq_gather_offset_z((uint8_t *)src, AIPL_2_BYTE_OFFSETS_U8, pred);
	uint8x16_t rg = vldrbq_gather_offset_z((uint8_t *)src + 1, AIPL_2_BYTE_OFFSETS_U8, pred);
 ...
 * @param src   source pixel vectors
 */
INLINE void aipl_mve_ldr_16px_rgbx4444_uncut(aipl_mve_rgb_x16_t *dst, const uint16_t *src)
{
 ...
 * @param src   source pixel vectors
 */
INLINE void aipl_mve_ldr_16px_rgba4444_uncut(aipl_mve_argb_x16_t *dst, const uint16_t *src)
{
	uint8x16x2_t rgba = vld2q((const uint8_t *)src);
 ...
 * @param src   source pixel vector
 */
INLINE void aipl_mve_cnvt_8px_rgba4444_to_argb4444(uint16x8_t *dst, uint16x8_t src)
{
	*dst = vshlq_n(src, 12);
	*dst = vsriq(*dst, src, 4);
}
 ...
 * @param src   source pixel vector
 */
INLINE void aipl_mve_cnvt_8px_rgba4444_to_yuv_y(uint16x8_t *dst, uint16x8_t src)
{
 ...
 * @param src   source pixel vector
 */
INLINE void aipl_mve_cnvt_8px_rgba4444_to_yuv_uv(uint16x8_t *u_dst, uint16x8_t *v_dst,
						 uint16x8_t src)
{
	uint16x8_t r = vandq(vshrq(src, 12), vdupq_n_u16(0x000f));
	uint16x8_t g = vandq(vshrq(src, 8), vdupq_n_u16(0x000f));
 ...
 * @param src   source pixel vector
 */
INLINE void aipl_mve_cnvt_8px_rgba4444_to_yuv(uint16x8_t *y_dst, uint16x8_t *u_dst,
					      uint16x8_t *v_dst, uint16x8_t src)
{
	uint16x8_t r = vandq(vshrq(src, 12), vdupq_n_u16(0x000f));
	uint16x8_t g = vandq(vshrq(src, 8), vdupq_n_u16(0x000f));
 ...
 * @param pred  vector predicate
 */
INLINE void aipl_mve_str_8px_rgba4444(uint16_t *dst, uint16x8_t src, mve_pred16_t pred)
{
	vstrhq_p(dst, src, pred);
}
 ...
 * @param pred  vector predicate
 */
INLINE void aipl_mve_str_8px_extended_rgba4444(uint16_t *dst, aipl_mve_argb_x8_t src,
					       mve_pred16_t pred)
{
 ...
 * @param pred  vector predicate
 */
INLINE void aipl_mve_str_16px_rgbx4444(uint16_t *dst, aipl_mve_rgb_x16_t src, mve_pred16_t pred)
{
 ...
 * @param pred  vector predicate
 */
INLINE void aipl_mve_str_16px_rgba4444(uint16_t *dst, aipl_mve_argb_x16_t src, mve_pred16_t pred)
{
	uint8x16_t rg = vsriq(src.r, src.g, 4);
 ...
 * @param src   source pixel vectors
 */
INLINE void aipl_mve_str_16px_rgbx4444_uncut(uint16_t *dst, aipl_mve_rgb_x16_t src)
{
 ...
 * @param src   source pixel vectors
 */
INLINE void aipl_mve_str_16px_rgba4444_uncut(uint16_t *dst, aipl_mve_argb_x16_t src)
{
 ...
 * @param pred      vector predicate
 */
INLINE void aipl_mve_ldr_8px_offset_rgba5551(uint16x8_t *dst, const uint16_t *src, uint8_t offset,
					     mve_pred16_t pred)
{
	*dst = vldrhq_gather_offset_z(src, AIPL_OFFSETS_U16(offset, 2), pred);
}
 ...
 * @param pred  vector predicate
 */
INLINE void aipl_mve_ldr_8px_rgba5551(uint16x8_t *dst, const uint16_t *src, mve_pred16_t pred)
{
	*dst = vldrhq_z_u16(src, pred);
}
 ...
 * @param pred  vector predicate
 */
INLINE void aipl_mve_ldr_16px_rgbx5551(aipl_mve_rgb_x16_t *dst, const uint16_t *src,
				       mve_pred16_t pred)
{
	uint8x16_t lower = vldrbq_gather_offset_z((uint8_t *)src, AIPL_2_BYTE_OFFSETS_U8, pred);
	uint8x16_t upper = vldrbq_gather_offset_z((uint8_t *)src + 1, AIPL_2_BYTE_OFFSETS_U8, pred);
 ...
 * @param pred  vector predicate
 */
INLINE void aipl_mve_ldr_16px_rgba5551(aipl_mve_argb_x16_t *dst, const uint16_t *src,
				       mve_pred16_t pred)
{
	uint8x16_t lower = vldrbq_gather_offset_z((uint8_t *)src, AIPL_2_BYTE_OFFSETS_U8, pred);
	uint8x16_t upper = vldrbq_gather_offset_z((uint8_t *)src + 1, AIPL_2_BYTE_OFFSETS_U8, pred);
 ...
 * @param src   source pixel vectors
 */
INLINE void aipl_mve_ldr_16px_rgbx5551_uncut(aipl_mve_rgb_x16_t *dst, const uint16_t *src)
{
	uint8x16x2_t rgba = vld2q((const uint8_t *)src);
 ...
 * @param src   source pixel vectors
 */
INLINE void aipl_mve_ldr_16px_rgba5551_uncut(aipl_mve_argb_x16_t *dst, const uint16_t *src)
{
	uint8x16x2_t rgba = vld2q((const uint8_t *)src);
 ...
 * @param src   source pixel vector
 */
INLINE void aipl_mve_cnvt_8px_rgba5551_to_yuv_y(uint16x8_t *dst, uint16x8_t src)
{
 ...
 * @param src   source pixel vector
 */
INLINE void aipl_mve_cnvt_8px_rgba5551_to_yuv_uv(uint16x8_t *u_dst, uint16x8_t *v_dst,
						 uint16x8_t src)
{
	uint16x8_t r = vandq(vshrq(src, 11), vdupq_n_u16(0x001f));
	uint16x8_t g = vandq(vshrq(src, 6), vdupq_n_u16(0x001f));
 ...
 * @param src   source pixel vector
 */
INLINE void aipl_mve_cnvt_8px_rgba5551_to_yuv(uint16x8_t *y_dst, uint16x8_t *u_dst,
					      uint16x8_t *v_dst, uint16x8_t src)
{
	uint16x8_t r = vandq(vshrq(src, 11), vdupq_n_u16(0x001f));
	uint16x8_t g = vandq(vshrq(src, 6), vdupq_n_u16(0x001f));
 ...
 * @param pred  vector predicate
 */
INLINE void aipl_mve_str_8px_rgba5551(uint16_t *dst, uint16x8_t src, mve_pred16_t pred)
{
	vstrhq_p(dst, src, pred);
}
 ...
 * @param pred  vector predicate
 */
INLINE void aipl_mve_str_16px_rgbx5551(uint16_t *dst, aipl_mve_rgb_x16_t src, mve_pred16_t pred)
{
 ...
 * @param pred  vector predicate
 */
INLINE void aipl_mve_str_16px_rgba5551(uint16_t *dst, aipl_mve_argb_x16_t src, mve_pred16_t pred)
{
	uint8x16_t upper = vsriq(src.r, src.g, 5);
	uint8x16_t lower = vshlq_n(src.g, 3);
 ...
 * @param src   source pixel vectors
 */
INLINE void aipl_mve_str_16px_rgbx5551_uncut(uint16_t *dst, aipl_mve_rgb_x16_t src)
{
 ...
 * @param src   source pixel vectors
 */
INLINE void aipl_mve_str_16px_rgba5551_uncut(uint16_t *dst, aipl_mve_argb_x16_t src)
{
	uint8x16x2_t rgba = {vshlq_n(src.g, 3), vsriq(src.r, src.g, 5)};
 ...
 * @param pred      vector predicate
 */
INLINE void aipl_mve_ldr_8px_offset_rgb565(uint16x8_t *dst, const uint16_t *src, uint8_t offset,
					   mve_pred16_t pred)
{
	*dst = vldrhq_gather_offset_z(src, AIPL_OFFSETS_U16(offset, 2), pred);
}
 ...
 * @param pred  vector predicate
 */
INLINE void aipl_mve_ldr_8px_rgb565(uint16x8_t *dst, const uint16_t *src, mve_pred16_t pred)
{
	*dst = vldrhq_z_u16(src, pred);
}
 ...
 * @param pred  vector predicate
 */
INLINE void aipl_mve_ldr_16px_rgb565(aipl_mve_rgb_x16_t *dst, const uint16_t *src,
				     mve_pred16_t pred)
{
	uint8x16_t lower = vldrbq_gather_offset_z((uint8_t *)src, AIPL_2_BYTE_OFFSETS_U8, pred);
	uint8x16_t upper = vldrbq_gather_offset_z((uint8_t *)src + 1, AIPL_2_BYTE_OFFSETS_U8, pred);
 ...
 * @param src   source pixel vectors
 */
INLINE void aipl_mve_ldr_16px_rgb565_uncut(aipl_mve_rgb_x16_t *dst, const uint16_t *src)
{
 ...
 * @param src   source pixel vector
 */
INLINE void aipl_mve_cnvt_8px_rgb565_to_yuv_y(uint16x8_t *dst, uint16x8_t src)
{
	uint16x8_t r = vandq(vshrq(src, 11), vdupq_n_u16(0x001f));
 ...
 * @param src   source pixel vector
 */
INLINE void aipl_mve_cnvt_8px_rgb565_to_yuv_uv(uint16x8_t *u_dst, uint16x8_t *v_dst, uint16x8_t src)
{
	uint16x8_t r = vandq(vshrq(src, 11), vdupq_n_u16(0x001f));
	uint16x8_t g = vandq(vshrq(src, 5), vdupq_n_u16(0x003f));
	uint16x8_t b = vandq(src, vdupq_n_u16(0x001f));
 ...
 * @param src   source pixel vector
 */
INLINE void aipl_mve_cnvt_8px_rgb565_to_yuv(uint16x8_t *y_dst, uint16x8_t *u_dst, uint16x8_t *v_dst,
					    uint16x8_t src)
{
	uint16x8_t r = vandq(vshrq(src, 11), vdupq_n_u16(0x001f));
	uint16x8_t g = vandq(vshrq(src, 5), vdupq_n_u16(0x003f));
 ...
 * @param pred  vector predicate
 */
INLINE void aipl_mve_str_8px_rgb565(uint16_t *dst, uint16x8_t src, mve_pred16_t pred)
{
	vstrhq_p(dst, src, pred);
}
 ...
 * @param pred  vector predicate
 */
INLINE void aipl_mve_str_16px_rgb565(uint16_t *dst, aipl_mve_rgb_x16_t src, mve_pred16_t pred)
{
	uint8x16_t upper = vsriq(src.r, src.g, 5);
	uint8x16_t lower = vshlq_n(src.g, 3);
 ...
 * @param src   source pixel vectors
 */
INLINE void aipl_mve_str_16px_rgb565_uncut(uint16_t *dst, aipl_mve_rgb_x16_t src)
{
 ...
 */
INLINE void aipl_mve_ldr_8px_rgb(aipl_mve_rgb_x8_t *dst, const uint8_t *src, mve_pred16_t pred,
 ...
 * @param b_offset  blue channel offset
 */
INLINE void aipl_mve_ldr_8px_offset_rgb(aipl_mve_rgb_x8_t *dst, const uint8_t *src, uint8_t offset,
					mve_pred16_t pred, uint8_t r_offset, uint8_t g_offset,
					uint8_t b_offset)
{
	offset *= 3;
 ...
 * @param b_offset  blue channel offset
 */
INLINE void aipl_mve_ldr_16px_rgb(aipl_mve_rgb_x16_t *dst, const uint8_t *src, mve_pred16_t pred,
				  uint8_t r_offset, uint8_t g_offset, uint8_t b_offset)
{
 ...
 * @param b_offset  blue channel offset
 */
INLINE void aipl_mve_ldr_16px_rgb_uncut(aipl_mve_rgb_x16_t *dst, const uint8_t *src,
					uint8_t r_offset, uint8_t g_offset, uint8_t b_offset)
{
 ...
 * @param src   source pixel vector
 */
INLINE void aipl_mve_cnvt_8px_rgb_to_yuv_y(uint16x8_t *dst, aipl_mve_rgb_x8_t src)
{
	aipl_mve_cnvt_8px_xrgb8888_to_yuv_y(dst, src);
}
 ...
 * @param src   source pixel vector
 */
INLINE void aipl_mve_cnvt_8px_rgb_to_yuv_u(uint16x8_t *dst, aipl_mve_rgb_x8_t src)
{
	aipl_mve_cnvt_8px_xrgb8888_to_yuv_u(dst, src);
}
 ...
 * @param src   source pixel vector
 */
INLINE void aipl_mve_cnvt_8px_rgb_to_yuv_v(uint16x8_t *dst, aipl_mve_rgb_x8_t src)
{
	aipl_mve_cnvt_8px_xrgb8888_to_yuv_v(dst, src);
}
 ...
 * @param b_offset  blue channel offset
 */
INLINE void aipl_mve_str_16px_rgb(uint8_t *dst, aipl_mve_rgb_x16_t src, mve_pred16_t pred,
				  uint8_t r_offset, uint8_t g_offset, uint8_t b_offset)
{
 ...
 * @param b_offset  blue channel offset
 */
INLINE void aipl_mve_str_16px_rgb_uncut(uint8_t *dst, aipl_mve_rgb_x16_t src, uint8_t r_offset,
 ...
 * @param pred  vector predicate
 */
INLINE void aipl_mve_ldr_4px_i400(uint32x4_t *dst, const uint8_t *src, mve_pred16_t pred)
{
 ...
 * @param pred  vector predicate
 */
INLINE void aipl_mve_ldr_8px_i400(uint16x8_t *dst, const uint8_t *src, mve_pred16_t pred)
{
 ...
 * @param pred  vector predicate
 */
INLINE void aipl_mve_ldr_16px_i400(uint8x16_t *dst, const uint8_t *src, mve_pred16_t pred)
{
 ...
 * @param src   source pixel vector
 */
INLINE void aipl_mve_cnvt_4px_i400_to_argb8888(uint32x4_t *dst, uint32x4_t src)
{
 ...
 * @param src   source pixel vector
 */
INLINE void aipl_mve_cnvt_8px_i400_to_argb4444(uint16x8_t *dst, uint16x8_t src)
{
	*dst = vshrq(src, 4);
 ...
 * @param src   source pixel vector
 */
INLINE void aipl_mve_cnvt_8px_i400_to_argb1555(uint16x8_t *dst, uint16x8_t src)
{
	*dst = vshrq(src, 3);
 ...
 * @param src   source pixel vector
 */
INLINE void aipl_mve_cnvt_4px_i400_to_rgba8888(uint32x4_t *dst, uint32x4_t src)
{
 ...
 * @param src   source pixel vector
 */
INLINE void aipl_mve_cnvt_8px_i400_to_rgba4444(uint16x8_t *dst, uint16x8_t src)
{
	*dst = vshrq(src, 4);
 ...
 * @param src   source pixel vector
 */
INLINE void aipl_mve_cnvt_8px_i400_to_rgba5551(uint16x8_t *dst, uint16x8_t src)
{
	*dst = vshrq(src, 3);
 ...
 * @param src   source pixel vector
 */
INLINE void aipl_mve_cnvt_8px_i400_to_rgb565(uint16x8_t *dst, uint16x8_t src)
{
	*dst = vshrq(src, 3);
 ...
 * @param src   source pixel vector
 */
INLINE void aipl_mve_cnvt_16px_i400_to_rgb(aipl_mve_rgb_x16_t *dst, uint8x16_t src)
{
	dst->r = src;
	dst->g = src;
	dst->b = src;
 ...
 * @param pred  vector predicate
 */
INLINE void aipl_mve_str_8px_i400(uint8_t *dst, uint16x8_t src, mve_pred16_t pred)
{
 ...
 */
INLINE void aipl_mve_pre_cnvt_4px_yuv_to_rgb(int32x4_t *r_dst, int32x4_t *g_dst, int32x4_t *b_dst,
					     uint32x4_t u, uint32x4_t v)
{
 ...
 */
INLINE void aipl_mve_pre_cnvt_8px_yuv_to_rgb(int32x4_t *r0_dst, int32x4_t *g0_dst,
					     int32x4_t *b0_dst, int32x4_t *r1_dst,
					     int32x4_t *g1_dst, int32x4_t *b1_dst, uint16x8_t u,
					     uint16x8_t v)
{
 ...
 */
INLINE void aipl_mve_pre_cnvt_4px_y(int32x4_t *c_dst, uint32x4_t y)
{
 ...
 * @param y      Y channel vector
 */
INLINE void aipl_mve_pre_cnvt_8px_y(int32x4_t *c0_dst, int32x4_t *c1_dst, uint16x8_t y)
{
	uint16x8_t c = y;
 ...
 */
INLINE void aipl_mve_pre_cnvt_8x2px_y(int32x4_t *c00_dst, int32x4_t *c01_dst, int32x4_t *c10_dst,
				      int32x4_t *c11_dst, uint16x8_t y0, uint16x8_t y1)
{
 ...
 */
INLINE void aipl_mve_cnvt_4px_yuv_to_rgb(int16x8_t *r_dst, int16x8_t *g_dst, int16x8_t *b_dst,
					 int32x4_t c_src, int32x4_t r_src, int32x4_t g_src,
					 int32x4_t b_src)
{
 ...
 */
INLINE void aipl_mve_cnvt_8px_yuv_to_rgb(uint16x8_t *r_dst, uint16x8_t *g_dst, uint16x8_t *b_dst,
					 int32x4_t c0_src, int32x4_t r0_src, int32x4_t g0_src,
					 int32x4_t b0_src, int32x4_t c1_src, int32x4_t r1_src,
					 int32x4_t g1_src, int32x4_t b1_src)
{
 ...
 * @param b_src     precalculated blue portion
 */
INLINE void aipl_mve_cnvt_4px_yuv_to_argb8888(uint32x4_t *dst, int32x4_t c_src, int32x4_t r_src,
					      int32x4_t g_src, int32x4_t b_src)
{
	int16x8_t r, g, b;
 ...
 * @param b_src     precalculated blue portion
 */
INLINE void aipl_mve_cnvt_8px_yuv_to_argb4444(uint16x8_t *dst, int32x4_t c0_src, int32x4_t c1_src,
					      int32x4_t r_src, int32x4_t g_src, int32x4_t b_src)
{
	uint16x8_t r, g, b;

	aipl_mve_cnvt_8px_yuv_to_rgb(&r, &g, &b, c0_src, r_src, g_src, b_src, c1_src, r_src, g_src,
				     b_src);
 ...
 */
INLINE void aipl_mve_cnvt_44px_yuv_to_argb4444(uint16x8_t *dst, int32x4_t c0_src, int32x4_t c1_src,
					       int32x4_t r0_src, int32x4_t g0_src, int32x4_t b0_src,
					       int32x4_t r1_src, int32x4_t g1_src, int32x4_t b1_src)
{
	uint16x8_t r, g, b;

	aipl_mve_cnvt_8px_yuv_to_rgb(&r, &g, &b, c0_src, r0_src, g0_src, b0_src, c1_src, r1_src,
				     g1_src, b1_src);
 ...
 * @param b_src     precalculated blue portion
 */
INLINE void aipl_mve_cnvt_8px_yuv_to_argb1555(uint16x8_t *dst, int32x4_t c0_src, int32x4_t c1_src,
					      int32x4_t r_src, int32x4_t g_src, int32x4_t b_src)
{
	uint16x8_t r, g, b;
 ...
 * @param b1_src    precalculated blue portion  [1]
 */
INLINE void aipl_mve_cnvt_44px_yuv_to_argb1555(uint16x8_t *dst, int32x4_t c0_src, int32x4_t c1_src,
					       int32x4_t r0_src, int32x4_t g0_src, int32x4_t b0_src,
					       int32x4_t r1_src, int32x4_t g1_src, int32x4_t b1_src)
{
	uint16x8_t r, g, b;
 ...
 * @param b_src     precalculated blue portion
 */
INLINE void aipl_mve_cnvt_4px_yuv_to_rgba8888(uint32x4_t *dst, int32x4_t c_src, int32x4_t r_src,
					      int32x4_t g_src, int32x4_t b_src)
{
	int16x8_t r, g, b;
 ...
 * @param b_src     precalculated blue portion
 */
INLINE void aipl_mve_cnvt_8px_yuv_to_rgba4444(uint16x8_t *dst, int32x4_t c0_src, int32x4_t c1_src,
					      int32x4_t r_src, int32x4_t g_src, int32x4_t b_src)
{
	uint16x8_t r, g, b;
	...
	*dst = vorrq(vorrq(vandq(vshlq_n(r, 8), vdupq_n_u16(0xf000)),
			   vandq(vshlq_n(g, 4), vdupq_n_u16(0x0f00))),
 ...
 * @param b1_src    precalculated blue portion  [1]
 */
INLINE void aipl_mve_cnvt_44px_yuv_to_rgba4444(uint16x8_t *dst, int32x4_t c0_src, int32x4_t c1_src,
					       int32x4_t r0_src, int32x4_t g0_src, int32x4_t b0_src,
					       int32x4_t r1_src, int32x4_t g1_src, int32x4_t b1_src)
{
	uint16x8_t r, g, b;
 ...
 * @param b_src     precalculated blue portion
 */
INLINE void aipl_mve_cnvt_8px_yuv_to_rgba5551(uint16x8_t *dst, int32x4_t c0_src, int32x4_t c1_src,
					      int32x4_t r_src, int32x4_t g_src, int32x4_t b_src)
{
	uint16x8_t r, g, b;
	...
	*dst = vorrq(vorrq(vdupq_n_u16(0x0001), vandq(vshlq_n(r, 8), vdupq_n_u16(0xf800))),
		     vorrq(vandq(vshlq_n(g, 3), vdupq_n_u16(0x07c0)),
			   vandq(vshrq(b, 2), vdupq_n_u16(0x03e))));
}
 ...
 * @param b1_src    precalculated blue portion  [1]
 */
INLINE void aipl_mve_cnvt_44px_yuv_to_rgba5551(uint16x8_t *dst, int32x4_t c0_src, int32x4_t c1_src,
					       int32x4_t r0_src, int32x4_t g0_src, int32x4_t b0_src,
					       int32x4_t r1_src, int32x4_t g1_src, int32x4_t b1_src)
{
	uint16x8_t r, g, b;
 ...
 * @param b_src     precalculated blue portion
 */
INLINE void aipl_mve_cnvt_8px_yuv_to_rgb565(uint16x8_t *dst, int32x4_t c0_src, int32x4_t c1_src,
					    int32x4_t r_src, int32x4_t g_src, int32x4_t b_src)
{
	uint16x8_t r, g, b;
 ...
 * @param b1_src    precalculated blue portion  [1]
 */
INLINE void aipl_mve_cnvt_44px_yuv_to_rgb565(uint16x8_t *dst, int32x4_t c0_src, int32x4_t c1_src,
					     int32x4_t r0_src, int32x4_t g0_src, int32x4_t b0_src,
					     int32x4_t r1_src, int32x4_t g1_src, int32x4_t b1_src)
{
	uint16x8_t r, g, b;
 ...
 */
INLINE void aipl_mve_color_correction_rgb_channels_x8(uint16x8_t *r, uint16x8_t *g, uint16x8_t *b,
						      const float *ccm)
{
 ...
 */
INLINE void aipl_mve_color_correction_argb_x8(aipl_mve_argb_x8_t *pix, const float *ccm)
{
 ...
 * @param ccm   color correction matrix
 */
INLINE void aipl_mve_color_correction_argb_x16(aipl_mve_argb_x16_t *pix, const float *ccm)
{
 ...
 * @param ccm   color correction matrix
 */
INLINE void aipl_mve_color_correction_rgb_x8(aipl_mve_rgb_x8_t *pix, const float *ccm)
{
	aipl_mve_color_correction_rgb_channels_x8(&pix->r, &pix->g, &pix->b, ccm);
}
 ...
 * @param ccm   color correction matrix
 */
INLINE void aipl_mve_color_correction_rgb_x16(aipl_mve_rgb_x16_t *pix, const float *ccm)
{
 ...
 */
INLINE void aipl_mve_white_balance_rgb_channels_x8(uint16x8_t *r, uint16x8_t *g, uint16x8_t *b,
 ...
 * @param ab    blue channel multiplier
 */
INLINE void aipl_mve_white_balance_argb_x8(aipl_mve_argb_x8_t *pix, float ar, float ag, float ab)
{
	aipl_mve_white_balance_rgb_channels_x8(&pix->r, &pix->g, &pix->b, ar, ag, ab);
}
 ...
 * @param ab    blue channel multiplier
 */
INLINE void aipl_mve_white_balance_argb_x16(aipl_mve_argb_x16_t *pix, float ar, float ag, float ab)
{
	aipl_mve_argb_x8_t pix_t;
	aipl_mve_argb_x8_t pix_b;
 ...
 * @param ab    blue channel multiplier
 */
INLINE void aipl_mve_white_balance_rgb_x8(aipl_mve_rgb_x8_t *pix, float ar, float ag, float ab)
{
	aipl_mve_white_balance_rgb_channels_x8(&pix->r, &pix->g, &pix->b, ar, ag, ab);
}
 ...
 * @param ab    blue channel multiplier
 */
INLINE void aipl_mve_white_balance_rgb_x16(aipl_mve_rgb_x16_t *pix, float ar, float ag, float ab)
{
	aipl_mve_rgb_x8_t pix_t;
	aipl_mve_rgb_x8_t pix_b;
 ...
 */
INLINE void aipl_mve_lut_transform_rgb_channels_x16(uint8x16_t *r, uint8x16_t *g, uint8x16_t *b,
						    uint8_t *lut)
{
 ...
 * @param lut   gamma lookup table
 */
INLINE void aipl_mve_lut_transform_argb_x16(aipl_mve_argb_x16_t *pix, uint8_t *lut)
{
 ...
 * @param lut   gamma lookup table
 */
INLINE void aipl_mve_lut_transform_rgb_x16(aipl_mve_rgb_x16_t *pix, uint8_t *lut)
{
	aipl_mve_lut_transform_rgb_channels_x16(&pix->r, &pix->g, &pix->b, lut);
}
