...
#undef __arm_vsriq
#define __arm_vsriq(p0, p1, p2)                                                                    \
	({                                                                                         \
		__typeof(p0) __p0 = (p0);                                                          \
		__typeof(p1) __p1 = (p1);                                                          \
		_Generic((int (*)[__ARM_mve_typeid(__p0)][__ARM_mve_typeid(__p1)])0,               \
			int (*)[__ARM_mve_type_int8x16_t]                                          \
			       [__ARM_mve_type_int8x16_t] : __arm_patched_vsriq_n_s8(               \
				       __ARM_mve_coerce(__p0, int8x16_t),                          \
				       __ARM_mve_coerce(__p1, int8x16_t), p2),                     \
			int (*)[__ARM_mve_type_int16x8_t]                                          \
			       [__ARM_mve_type_int16x8_t] : __arm_patched_vsriq_n_s16(              \
				       __ARM_mve_coerce(__p0, int16x8_t),                          \
				       __ARM_mve_coerce(__p1, int16x8_t), p2),                     \
			int (*)[__ARM_mve_type_int32x4_t]                                          \
			       [__ARM_mve_type_int32x4_t] : __arm_patched_vsriq_n_s32(              \
				       __ARM_mve_coerce(__p0, int32x4_t),                          \
				       __ARM_mve_coerce(__p1, int32x4_t), p2),                     \
			int (*)[__ARM_mve_type_uint8x16_t]                                         \
			       [__ARM_mve_type_uint8x16_t] : __arm_patched_vsriq_n_u8(              \
				       __ARM_mve_coerce(__p0, uint8x16_t),                         \
				       __ARM_mve_coerce(__p1, uint8x16_t), p2),                    \
			int (*)[__ARM_mve_type_uint16x8_t]                                         \
			       [__ARM_mve_type_uint16x8_t] : __arm_patched_vsriq_n_u16(             \
				       __ARM_mve_coerce(__p0, uint16x8_t),                         \
				       __ARM_mve_coerce(__p1, uint16x8_t), p2),                    \
			int (*)[__ARM_mve_type_uint32x4_t]                                         \
			       [__ARM_mve_type_uint32x4_t] : __arm_patched_vsriq_n_u32(             \
				       __ARM_mve_coerce(__p0, uint32x4_t),                         \
				       __ARM_mve_coerce(__p1, uint32x4_t), p2));                   \
	})

__extension__ extern inline int8x16_t
...
__extension__ extern inline int16x8_t
	__attribute__((__always_inline__, __gnu_inline__, __artificial__))
...
__extension__ extern inline int32x4_t
	__attribute__((__always_inline__, __gnu_inline__, __artificial__))
...
__extension__ extern inline uint8x16_t
	__attribute__((__always_inline__, __gnu_inline__, __artificial__))
...
__extension__ extern inline uint16x8_t
	__attribute__((__always_inline__, __gnu_inline__, __artificial__))
...
__extension__ extern inline uint32x4_t
	__attribute__((__always_inline__, __gnu_inline__, __artificial__))
