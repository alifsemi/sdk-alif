 ...
 * @param src source ARGB8888 pixel pointer
 */
INLINE void aipl_cnvt_px_argb8888_to_rgb565(aipl_rgb565_px_t *dst, const aipl_argb8888_px_t *src)
{
	dst->t = (src->r & 0xf8) | (src->g >> 5);
 ...
 */
INLINE void aipl_cnvt_px_argb8888_to_24bit(uint8_t *dst, const aipl_argb8888_px_t *src,
 ...
 * @param src source ARGB8888 pixel pointer
 */
INLINE void aipl_cnvt_px_argb8888_to_yuv_y(uint8_t *dst, const aipl_argb8888_px_t *src)
{
 ...
 * @param src source ARGB8888 pixel pointer
 */
INLINE void aipl_cnvt_px_argb8888_to_yuv_uv(uint8_t *u_dst, uint8_t *v_dst,
					    const aipl_argb8888_px_t *src)
{
	uint8_t r = src->r;
	uint8_t g = src->g;
 ...
 * @param src   source ARGB8888 pixel pointer
 */
INLINE void aipl_cnvt_px_argb8888_to_yuv(uint8_t *y_dst, uint8_t *u_dst, uint8_t *v_dst,
					 const aipl_argb8888_px_t *src)
{
	uint8_t r = src->r;
	uint8_t g = src->g;
...
INLINE void aipl_cnvt_px_argb4444_to_argb1555(aipl_argb1555_px_t *dst,
					      const aipl_argb4444_px_t *src)
{
	dst->t = (src->ar & 0x80) | ((src->ar << 3) & 0x7c) | (src->gb >> 6);
					      ...
					      const aipl_argb4444_px_t *src)
{
	...
	dst->b = ((src->gb << 3) & 0x80) | ((src->gb << 2) & 0x3e) | (src->ar >> 7);
}
 ...
 * @param b_offset  blue channel offset
 */
INLINE void aipl_cnvt_px_argb4444_to_24bit(uint8_t *dst, const aipl_argb4444_px_t *src,
					   uint8_t r_offset, uint8_t g_offset, uint8_t b_offset)
{
 ...
 * @param src source ARGB4444 pixel pointer
 */
INLINE void aipl_cnvt_px_argb4444_to_rgb565(aipl_rgb565_px_t *dst, const aipl_argb4444_px_t *src)
{
	dst->t = (src->ar << 4) | (src->gb >> 5);
 ...
 * @param src source ARGB4444 pixel pointer
 */
INLINE void aipl_cnvt_px_argb4444_to_yuv_y(uint8_t *dst, const aipl_argb4444_px_t *src)
{
 ...
 * @param src   source ARGB4444 pixel pointer
 */
INLINE void aipl_cnvt_px_argb4444_to_yuv_uv(uint8_t *u_dst, uint8_t *v_dst,
					    const aipl_argb4444_px_t *src)
{
	uint8_t r = src->ar & 0x0f;
	uint8_t g = src->gb >> 4;
 ...
 * @param src   source ARGB4444 pixel pointer
 */
INLINE void aipl_cnvt_px_argb4444_to_yuv(uint8_t *y_dst, uint8_t *u_dst, uint8_t *v_dst,
					 const aipl_argb4444_px_t *src)
{
	uint8_t r = src->ar & 0x0f;
	uint8_t g = src->gb >> 4;
					      ...
					      const aipl_argb1555_px_t *src)
{
	...
	dst->gb = (src->t << 6) | ((src->b >> 2) & 0x30) | ((src->b >> 1) & 0x0f);
}
...
INLINE void aipl_cnvt_px_argb1555_to_rgba4444(aipl_rgba4444_px_t *dst,
					      const aipl_argb1555_px_t *src)
{
	dst->rg = ((src->t << 1) & 0xf0) | ((src->t << 2) & 0x0f) | (src->b >> 6);
 ...
 * @param b_offset  blue channel offset
 */
INLINE void aipl_cnvt_px_argb1555_to_24bit(uint8_t *dst, const aipl_argb1555_px_t *src,
					   uint8_t r_offset, uint8_t g_offset, uint8_t b_offset)
{
 ...
 * @param src source ARGB1555 pixel pointer
 */
INLINE void aipl_cnvt_px_argb1555_to_rgb565(aipl_rgb565_px_t *dst, const aipl_argb1555_px_t *src)
{
 ...
 * @param src source ARGB1555 pixel pointer
 */
INLINE void aipl_cnvt_px_argb1555_to_yuv_y(uint8_t *dst, const aipl_argb1555_px_t *src)
{
 ...
 * @param src   source ARGB1555 pixel pointer
 */
INLINE void aipl_cnvt_px_argb1555_to_yuv_uv(uint8_t *u_dst, uint8_t *v_dst,
					    const aipl_argb1555_px_t *src)
{
	uint8_t r = (src->t >> 2) & 0x1f;
	uint8_t g = ((src->t << 3) & 0x1f) | (src->b >> 5);
 ...
 * @param src   source ARGB1555 pixel pointer
 */
INLINE void aipl_cnvt_px_argb1555_to_yuv(uint8_t *y_dst, uint8_t *u_dst, uint8_t *v_dst,
					 const aipl_argb1555_px_t *src)
{
	uint8_t r = (src->t >> 2) & 0x1f;
	uint8_t g = ((src->t << 3) & 0x1f) | (src->b >> 5);
 ...
 * @param b_offset  blue channel offset
 */
INLINE void aipl_cnvt_px_rgba8888_to_24bit(uint8_t *dst, const aipl_rgba8888_px_t *src,
					   uint8_t r_offset, uint8_t g_offset, uint8_t b_offset)
{
	dst[r_offset] = src->r;
	dst[g_offset] = src->g;
 ...
 * @param src source RGBA8888 pixel pointer
 */
INLINE void aipl_cnvt_px_rgba8888_to_rgb565(aipl_rgb565_px_t *dst, const aipl_rgba8888_px_t *src)
{
	dst->t = (src->r & 0xf8) | (src->g >> 5);
	dst->b = ((src->g << 3) & 0xe0) | (src->b >> 3);
}
 ...
 * @param src source RGBA8888 pixel pointer
 */
INLINE void aipl_cnvt_px_rgba8888_to_yuv_y(uint8_t *dst, const aipl_rgba8888_px_t *src)
{
	*dst = ((66 * src->r + 129 * src->g + 25 * src->b + 128) >> 8) + 16;
}
 ...
 * @param src   source RGBA8888 pixel pointer
 */
INLINE void aipl_cnvt_px_rgba8888_to_yuv_uv(uint8_t *u_dst, uint8_t *v_dst,
					    const aipl_rgba8888_px_t *src)
{
	uint8_t r = src->r;
	uint8_t g = src->g;
 ...
 * @param src   source RGBA8888 pixel pointer
 */
INLINE void aipl_cnvt_px_rgba8888_to_yuv(uint8_t *y_dst, uint8_t *u_dst, uint8_t *v_dst,
					 const aipl_rgba8888_px_t *src)
{
	uint8_t r = src->r;
	uint8_t g = src->g;
...
INLINE void aipl_cnvt_px_rgba4444_to_argb1555(aipl_argb1555_px_t *dst,
					      const aipl_rgba4444_px_t *src)
{
	dst->t = ((src->ba << 4) & 0x80) | ((src->rg >> 1) & 0x78) | ((src->rg >> 2) & 0x03);
					      ...
					      const aipl_rgba4444_px_t *src)
{
	...
	dst->b = (src->rg << 7) | ((src->ba >> 2) & 0x3c) | ((src->ba >> 3) & 0x01);
}
 ...
 * @param b_offset  blue channel offset
 */
INLINE void aipl_cnvt_px_rgba4444_to_24bit(uint8_t *dst, const aipl_rgba4444_px_t *src,
					   uint8_t r_offset, uint8_t g_offset, uint8_t b_offset)
{
 ...
 * @param src source RGBA4444 pixel pointer
 */
INLINE void aipl_cnvt_px_rgba4444_to_rgb565(aipl_rgb565_px_t *dst, const aipl_rgba4444_px_t *src)
{
	dst->t = (src->rg & 0xf0) | ((src->rg >> 1) & 0x07);
 ...
 * @param src source RGBA4444 pixel pointer
 */
INLINE void aipl_cnvt_px_rgba4444_to_yuv_y(uint8_t *dst, const aipl_rgba4444_px_t *src)
{
	uint8_t r = src->rg >> 4;
 ...
 * @param src   source RGBA4444 pixel pointer
 */
INLINE void aipl_cnvt_px_rgba4444_to_yuv_uv(uint8_t *u_dst, uint8_t *v_dst,
					    const aipl_rgba4444_px_t *src)
{
	uint8_t r = src->rg >> 4;
	uint8_t g = src->rg & 0x0f;
 ...
 * @param src   source RGBA4444 pixel pointer
 */
INLINE void aipl_cnvt_px_rgba4444_to_yuv(uint8_t *y_dst, uint8_t *u_dst, uint8_t *v_dst,
					 const aipl_rgba4444_px_t *src)
{
	uint8_t r = src->rg >> 4;
	uint8_t g = src->rg & 0x0f;
 ...
 * @param b_offset  blue channel offset
 */
INLINE void aipl_cnvt_px_rgba5551_to_24bit(uint8_t *dst, const aipl_rgba5551_px_t *src,
					   uint8_t r_offset, uint8_t g_offset, uint8_t b_offset)
{
 ...
 * @param src source RGBA5551 pixel pointer
 */
INLINE void aipl_cnvt_px_rgba5551_to_rgb565(aipl_rgb565_px_t *dst, const aipl_rgba5551_px_t *src)
{
	dst->t = src->t;
 ...
 * @param src source RGBA5551 pixel pointer
 */
INLINE void aipl_cnvt_px_rgba5551_to_yuv_y(uint8_t *dst, const aipl_rgba5551_px_t *src)
{
 ...
 * @param src   source RGBA5551 pixel pointer
 */
INLINE void aipl_cnvt_px_rgba5551_to_yuv_uv(uint8_t *u_dst, uint8_t *v_dst,
					    const aipl_rgba5551_px_t *src)
{
	uint8_t r = (src->t >> 3) & 0x1f;
	uint8_t g = ((src->t << 2) & 0x1f) | (src->b >> 6);
 ...
 * @param src   source RGBA5551 pixel pointer
 */
INLINE void aipl_cnvt_px_rgba5551_to_yuv(uint8_t *y_dst, uint8_t *u_dst, uint8_t *v_dst,
					 const aipl_rgba5551_px_t *src)
{
	uint8_t r = (src->t >> 3) & 0x1f;
	uint8_t g = ((src->t << 2) & 0x1f) | (src->b >> 6);
 ...
 * @param b_offset  blue channel offset
 */
INLINE void aipl_cnvt_px_24bit_to_argb8888(aipl_argb8888_px_t *dst, const uint8_t *src,
					   uint8_t r_offset, uint8_t g_offset, uint8_t b_offset)
{
	dst->a = 0xff;
	dst->r = src[r_offset];
 ...
 * @param b_offset  blue channel offset
 */
INLINE void aipl_cnvt_px_24bit_to_argb4444(aipl_argb4444_px_t *dst, const uint8_t *src,
					   uint8_t r_offset, uint8_t g_offset, uint8_t b_offset)
{
 ...
 * @param b_offset  blue channel offset
 */
INLINE void aipl_cnvt_px_24bit_to_argb1555(aipl_argb1555_px_t *dst, const uint8_t *src,
					   uint8_t r_offset, uint8_t g_offset, uint8_t b_offset)
{
 ...
 * @param b_offset  blue channel offset
 */
INLINE void aipl_cnvt_px_24bit_to_rgba8888(aipl_rgba8888_px_t *dst, const uint8_t *src,
					   uint8_t r_offset, uint8_t g_offset, uint8_t b_offset)
{
	dst->r = src[r_offset];
	dst->g = src[g_offset];
 ...
 * @param b_offset  blue channel offset
 */
INLINE void aipl_cnvt_px_24bit_to_rgba4444(aipl_rgba4444_px_t *dst, const uint8_t *src,
					   uint8_t r_offset, uint8_t g_offset, uint8_t b_offset)
{
 ...
 * @param b_offset  blue channel offset
 */
INLINE void aipl_cnvt_px_24bit_to_rgba5551(aipl_rgba5551_px_t *dst, const uint8_t *src,
					   uint8_t r_offset, uint8_t g_offset, uint8_t b_offset)
{
 ...
 */
INLINE void aipl_cnvt_px_24bit_to_24bit(uint8_t *dst, const uint8_t *src, uint8_t r_src_offset,
					uint8_t g_src_offset, uint8_t b_src_offset,
					uint8_t r_dst_offset, uint8_t g_dst_offset,
 ...
 * @param b_offset  blue channel offset
 */
INLINE void aipl_cnvt_px_24bit_to_rgb565(aipl_rgb565_px_t *dst, const uint8_t *src,
					 uint8_t r_offset, uint8_t g_offset, uint8_t b_offset)
{
	dst->t = (src[r_offset] & 0xf8) | (src[g_offset] >> 5);
 ...
 * @param b_offset  blue channel offset
 */
INLINE void aipl_cnvt_px_24bit_to_yuv_y(uint8_t *dst, const uint8_t *src, uint8_t r_offset,
 ...
 * @param b_offset  blue channel offset
 */
INLINE void aipl_cnvt_px_24bit_to_yuv_uv(uint8_t *u_dst, uint8_t *v_dst, const uint8_t *src,
					 uint8_t r_offset, uint8_t g_offset, uint8_t b_offset)
{
	*u_dst =
		((-38 * src[r_offset] - 74 * src[g_offset] + 112 * src[b_offset] + 128) >> 8) + 128;
 ...
 * @param b_offset  blue channel offset
 */
INLINE void aipl_cnvt_px_24bit_to_yuv(uint8_t *y_dst, uint8_t *u_dst, uint8_t *v_dst,
				      const uint8_t *src, uint8_t r_offset, uint8_t g_offset,
				      uint8_t b_offset)
{
 ...
 */
INLINE void aipl_cnvt_px_rgb565_to_argb8888(aipl_argb8888_px_t *dst, const aipl_rgb565_px_t *src)
{
	dst->a = 0xff;
	dst->r = (src->t & 0xf8) | ((src->t >> 5) & 0x07);
 ...
 * @param src source RGB565 pixel pointer
 */
INLINE void aipl_cnvt_px_rgb565_to_argb4444(aipl_argb4444_px_t *dst, const aipl_rgb565_px_t *src)
{
	dst->ar = 0xf0 | (src->t >> 4);
 ...
 * @param src source RGB565 pixel pointer
 */
INLINE void aipl_cnvt_px_rgb565_to_argb1555(aipl_argb1555_px_t *dst, const aipl_rgb565_px_t *src)
{
	dst->t = 0x80 | (src->t >> 1);
 ...
 * @param src source RGB565 pixel pointer
 */
INLINE void aipl_cnvt_px_rgb565_to_rgba8888(aipl_rgba8888_px_t *dst, const aipl_rgb565_px_t *src)
{
	dst->r = (src->t & 0xf8) | ((src->t >> 5) & 0x07);
	dst->g = (src->t & 0x03) | (src->t << 5) | ((src->b >> 3) & 0x1c);
	dst->b = ((src->b & 0x1f) << 3) | ((src->b >> 2) & 0x07);
 ...
 * @param src source RGB565 pixel pointer
 */
INLINE void aipl_cnvt_px_rgb565_to_rgba4444(aipl_rgba4444_px_t *dst, const aipl_rgb565_px_t *src)
{
	dst->rg = (src->t & 0xf0) | ((src->t << 1) & 0x0f) | (src->b >> 7);
 ...
 * @param src source RGB565 pixel pointer
 */
INLINE void aipl_cnvt_px_rgb565_to_rgba5551(aipl_rgba5551_px_t *dst, const aipl_rgb565_px_t *src)
{
	dst->t = src->t;
 ...
 * @param b_offset  blue channel offset
 */
INLINE void aipl_cnvt_px_rgb565_to_24bit(uint8_t *dst, const aipl_rgb565_px_t *src,
					 uint8_t r_offset, uint8_t g_offset, uint8_t b_offset)
{
	dst[r_offset] = (src->t & 0xf8) | ((src->t >> 5) & 0x07);
 ...
 * @param src source RGB565 pixel pointer
 */
INLINE void aipl_cnvt_px_rgb565_to_yuv_y(uint8_t *dst, const aipl_rgb565_px_t *src)
{
	uint8_t r = (src->t >> 3) & 0x1f;
 ...
 * @param src   source RGBA5551 pixel pointer
 */
INLINE void aipl_cnvt_px_rgb565_to_yuv_uv(uint8_t *u_dst, uint8_t *v_dst,
 ...
 * @param src   source RGB565 pixel pointer
 */
INLINE void aipl_cnvt_px_rgb565_to_yuv(uint8_t *y_dst, uint8_t *u_dst, uint8_t *v_dst,
				       const aipl_rgb565_px_t *src)
{
	uint8_t r = (src->t >> 3) & 0x1f;
	uint8_t g = ((src->t << 3) & 0x3f) | (src->b >> 5);
 ...
 */
INLINE void aipl_cnvt_px_i400_to_argb8888(aipl_argb8888_px_t *dst, const uint8_t *src)
{
	dst->a = 0xff;
	dst->r = *src;
	dst->g = *src;
 ...
 * @param src source ALPHA8/I400 pixel pointer
 */
INLINE void aipl_cnvt_px_i400_to_argb4444(aipl_argb4444_px_t *dst, const uint8_t *src)
{
	dst->ar = 0xf0 | (*src >> 4);
 ...
 * @param src source ALPHA8/I400 pixel pointer
 */
INLINE void aipl_cnvt_px_i400_to_argb1555(aipl_argb1555_px_t *dst, const uint8_t *src)
{
 ...
 * @param src source ALPHA8/I400 pixel pointer
 */
INLINE void aipl_cnvt_px_i400_to_rgba8888(aipl_rgba8888_px_t *dst, const uint8_t *src)
{
	dst->a = 0xff;
	dst->r = *src;
	dst->g = *src;
 ...
 * @param src source ALPHA8/I400 pixel pointer
 */
INLINE void aipl_cnvt_px_i400_to_rgba4444(aipl_rgba4444_px_t *dst, const uint8_t *src)
{
 ...
 * @param src source ALPHA8/I400 pixel pointer
 */
INLINE void aipl_cnvt_px_i400_to_rgba5551(aipl_rgba5551_px_t *dst, const uint8_t *src)
{
 ...
 * @param src source ALPHA8/I400 pixel pointer
 */
INLINE void aipl_cnvt_px_i400_to_24bit(uint8_t *dst, const uint8_t *src)
{
	uint8_t tmp = *src;
 ...
 * @param src source ALPHA8/I400 pixel pointer
 */
INLINE void aipl_cnvt_px_i400_to_rgb565(aipl_rgb565_px_t *dst, const uint8_t *src)
{
	dst->t = (*src & 0xf8) | (*src >> 5);
 ...
 */
INLINE void aipl_pre_cnvt_px_yuv_to_rgb(int32_t *r, int32_t *g, int32_t *b, uint8_t u, uint8_t v)
{
	int16_t d = u - 128;
	int16_t e = v - 128;
 ...
 */
INLINE void aipl_pre_cnvt_2px_y(int32_t *c0, int32_t *c1, uint8_t y0, uint8_t y1)
{
 ...
 */
INLINE void aipl_pre_cnvt_2x2px_y(int32_t *c00, int32_t *c01, int32_t *c10, int32_t *c11,
				  uint8_t y00, uint8_t y01, uint8_t y10, uint8_t y11)
{
 ...
 */
INLINE void aipl_cnvt_px_yuv_to_argb8888(aipl_argb8888_px_t *dst, int32_t c, int32_t r, int32_t g,
					 int32_t b)
{
	dst->a = 0xff;
 ...
 * @param b     source pixel B precalculated value
 */
INLINE void aipl_cnvt_px_yuv_to_argb4444(aipl_argb4444_px_t *dst, int32_t c, int32_t r, int32_t g,
					 int32_t b)
{
	dst->ar = 0xf0 | aipl_channel_cap_4bit((c + r) >> 12);
	dst->gb = aipl_channel_cap_upper_4bit((c + g) >> 12) | aipl_channel_cap_4bit((c + b) >> 12);
}
 ...
 * @param b     source pixel B precalculated value
 */
INLINE void aipl_cnvt_px_yuv_to_argb1555(aipl_argb1555_px_t *dst, int32_t c, int32_t r, int32_t g,
					 int32_t b)
{
	uint8_t g0 = aipl_channel_cap_5bit((c + g) >> 11, 0);

	dst->t = 0x80 | aipl_channel_cap_5bit((c + r) >> 11, 2) | (g0 >> 3);
 ...
 * @param b     source pixel B precalculated value
 */
INLINE void aipl_cnvt_px_yuv_to_rgba8888(aipl_rgba8888_px_t *dst, int32_t c, int32_t r, int32_t g,
					 int32_t b)
{
	dst->r = aipl_channel_cap((c + r) >> 8);
	dst->g = aipl_channel_cap((c + g) >> 8);
 ...
 * @param b     source pixel B precalculated value
 */
INLINE void aipl_cnvt_px_yuv_to_rgba4444(aipl_rgba4444_px_t *dst, int32_t c, int32_t r, int32_t g,
					 int32_t b)
{
	dst->rg = aipl_channel_cap_upper_4bit((c + r) >> 12) | aipl_channel_cap_4bit((c + g) >> 12);
	dst->ba = aipl_channel_cap_upper_4bit((c + b) >> 12) | 0x0f;
}
 ...
 * @param b     source pixel B precalculated value
 */
INLINE void aipl_cnvt_px_yuv_to_rgba5551(aipl_rgba5551_px_t *dst, int32_t c, int32_t r, int32_t g,
					 int32_t b)
{
	uint8_t g0 = aipl_channel_cap_5bit((c + g) >> 11, 0);

	dst->t = aipl_channel_cap_5bit((c + r) >> 11, 3) | (g0 >> 2);
	dst->b = (g0 << 6) | aipl_channel_cap_5bit((c + b) >> 11, 1) | 0x01;
}
 ...
 * @param b_offset  blue channel offset
 */
INLINE void aipl_cnvt_px_yuv_to_24bit(uint8_t *dst, int32_t c, int32_t r, int32_t g, int32_t b,
				      uint8_t r_offset, uint8_t g_offset, uint8_t b_offset)
{
 ...
 * @param b     source pixel B precalculated value
 */
INLINE void aipl_cnvt_px_yuv_to_rgb565(aipl_rgb565_px_t *dst, int32_t c, int32_t r, int32_t g,
				       int32_t b)
{
