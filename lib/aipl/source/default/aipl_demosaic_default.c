...
static INLINE void aipl_bayer_to_rgb(uint8_t *rgb0, uint8_t *rgb1, aipl_bayer_tile_t *tile,
				     uint32_t idx);
static aipl_error_t aipl_demosaic_yuv_planar(const void *input, uint8_t *y, uint8_t *u, uint8_t *v,
					     uint32_t pitch, uint32_t width, uint32_t height,
					     aipl_bayer_filter_t filter);
static aipl_error_t aipl_demosaic_yuv_semi_planar(const void *input, uint8_t *y, uint8_t *u,
						  uint8_t *v, uint32_t pitch, uint32_t width,
						  uint32_t height, aipl_bayer_filter_t filter);
static aipl_error_t aipl_demosaic_yuv_packed(const void *input, uint8_t *y, uint8_t *u, uint8_t *v,
					     uint32_t pitch, uint32_t width, uint32_t height,
					     aipl_bayer_filter_t filter);
...
aipl_error_t aipl_demosaic_default(const void *input, void *output, uint32_t pitch, uint32_t width,
				   uint32_t height, aipl_bayer_filter_t filter,
				   aipl_color_format_t format)
{
	switch (format) {
	case AIPL_COLOR_ALPHA8:
		return aipl_demosaic_alpha8_default(input, output, pitch, width, height, filter);
	case AIPL_COLOR_ARGB8888:
		return aipl_demosaic_argb8888_default(input, output, pitch, width, height, filter);
	case AIPL_COLOR_ARGB4444:
		return aipl_demosaic_argb4444_default(input, output, pitch, width, height, filter);
	case AIPL_COLOR_ARGB1555:
		return aipl_demosaic_argb1555_default(input, output, pitch, width, height, filter);
	case AIPL_COLOR_RGBA8888:
		return aipl_demosaic_rgba8888_default(input, output, pitch, width, height, filter);
	case AIPL_COLOR_RGBA4444:
		return aipl_demosaic_rgba4444_default(input, output, pitch, width, height, filter);
	case AIPL_COLOR_RGBA5551:
		return aipl_demosaic_rgba5551_default(input, output, pitch, width, height, filter);
	case AIPL_COLOR_RGB888:
		return aipl_demosaic_rgb888_default(input, output, pitch, width, height, filter);
	case AIPL_COLOR_BGR888:
		return aipl_demosaic_bgr888_default(input, output, pitch, width, height, filter);
	case AIPL_COLOR_RGB565:
		return aipl_demosaic_rgb565_default(input, output, pitch, width, height, filter);
	case AIPL_COLOR_YV12:
		return aipl_demosaic_yv12_default(input, output, pitch, width, height, filter);
	case AIPL_COLOR_I420:
		return aipl_demosaic_i420_default(input, output, pitch, width, height, filter);
	case AIPL_COLOR_I422:
		return aipl_demosaic_i422_default(input, output, pitch, width, height, filter);
	case AIPL_COLOR_I444:
		return aipl_demosaic_i444_default(input, output, pitch, width, height, filter);
	case AIPL_COLOR_I400:
		return aipl_demosaic_i400_default(input, output, pitch, width, height, filter);
	case AIPL_COLOR_NV12:
		return aipl_demosaic_nv12_default(input, output, pitch, width, height, filter);
	case AIPL_COLOR_NV21:
		return aipl_demosaic_nv21_default(input, output, pitch, width, height, filter);
	case AIPL_COLOR_YUY2:
		return aipl_demosaic_yuy2_default(input, output, pitch, width, height, filter);
	case AIPL_COLOR_UYVY:
		return aipl_demosaic_uyvy_default(input, output, pitch, width, height, filter);
...
aipl_error_t aipl_demosaic_img_default(const void *input, aipl_image_t *output, uint32_t pitch,
				       aipl_bayer_filter_t filter)
{
	...
	return aipl_demosaic_default(input, output->data, pitch, output->width, output->height,
				     filter, output->format);
}

aipl_error_t aipl_demosaic_alpha8_default(const void *input, void *output, uint32_t pitch,
...
aipl_error_t aipl_demosaic_argb8888_default(const void *input, void *output, uint32_t pitch,
					    uint32_t width, uint32_t height,
					    aipl_bayer_filter_t filter)
{
	if (input == NULL || output == NULL) {
...
aipl_error_t aipl_demosaic_argb4444_default(const void *input, void *output, uint32_t pitch,
					    uint32_t width, uint32_t height,
					    aipl_bayer_filter_t filter)
{
	if (input == NULL || output == NULL) {
...
aipl_error_t aipl_demosaic_argb1555_default(const void *input, void *output, uint32_t pitch,
					    uint32_t width, uint32_t height,
					    aipl_bayer_filter_t filter)
{
	if (input == NULL || output == NULL) {
...
aipl_error_t aipl_demosaic_rgba8888_default(const void *input, void *output, uint32_t pitch,
					    uint32_t width, uint32_t height,
					    aipl_bayer_filter_t filter)
{
	if (input == NULL || output == NULL) {
...
aipl_error_t aipl_demosaic_rgba4444_default(const void *input, void *output, uint32_t pitch,
					    uint32_t width, uint32_t height,
					    aipl_bayer_filter_t filter)
{
	if (input == NULL || output == NULL) {
...
aipl_error_t aipl_demosaic_rgba5551_default(const void *input, void *output, uint32_t pitch,
					    uint32_t width, uint32_t height,
					    aipl_bayer_filter_t filter)
{
	if (input == NULL || output == NULL) {
...
aipl_error_t aipl_demosaic_rgb888_default(const void *input, void *output, uint32_t pitch,
					  uint32_t width, uint32_t height,
					  aipl_bayer_filter_t filter)
{
	if (input == NULL || output == NULL) {
...
aipl_error_t aipl_demosaic_bgr888_default(const void *input, void *output, uint32_t pitch,
					  uint32_t width, uint32_t height,
					  aipl_bayer_filter_t filter)
{
	if (input == NULL || output == NULL) {
...
aipl_error_t aipl_demosaic_rgb565_default(const void *input, void *output, uint32_t pitch,
					  uint32_t width, uint32_t height,
					  aipl_bayer_filter_t filter)
{
	if (input == NULL || output == NULL) {
...
aipl_error_t aipl_demosaic_yv12_default(const void *input, void *output, uint32_t pitch,
					uint32_t width, uint32_t height, aipl_bayer_filter_t filter)
{
	...
	return aipl_demosaic_yuv_planar(input, y, u, v, pitch, width, height, filter);
}

aipl_error_t aipl_demosaic_i420_default(const void *input, void *output, uint32_t pitch,
					uint32_t width, uint32_t height, aipl_bayer_filter_t filter)
{
	uint8_t *y = output;
...
aipl_error_t aipl_demosaic_i422_default(const void *input, void *output, uint32_t pitch,
					uint32_t width, uint32_t height, aipl_bayer_filter_t filter)
{
	if (input == NULL || output == NULL) {
		return AIPL_ERR_NULL_POINTER;
...
aipl_error_t aipl_demosaic_i444_default(const void *input, void *output, uint32_t pitch,
					uint32_t width, uint32_t height, aipl_bayer_filter_t filter)
{
	if (input == NULL || output == NULL) {
		return AIPL_ERR_NULL_POINTER;
...
aipl_error_t aipl_demosaic_i400_default(const void *input, void *output, uint32_t pitch,
					uint32_t width, uint32_t height, aipl_bayer_filter_t filter)
{
	return aipl_demosaic_alpha8_default(input, output, pitch, width, height, filter);
}

aipl_error_t aipl_demosaic_nv12_default(const void *input, void *output, uint32_t pitch,
					uint32_t width, uint32_t height, aipl_bayer_filter_t filter)
{
	uint8_t *y = output;
	uint8_t *u = y + width * height;
	...
	return aipl_demosaic_yuv_semi_planar(input, y, u, v, pitch, width, height, filter);
}

aipl_error_t aipl_demosaic_nv21_default(const void *input, void *output, uint32_t pitch,
					uint32_t width, uint32_t height, aipl_bayer_filter_t filter)
{
	uint8_t *y = output;
	uint8_t *v = y + width * height;
...
aipl_error_t aipl_demosaic_yuy2_default(const void *input, void *output, uint32_t pitch,
					uint32_t width, uint32_t height, aipl_bayer_filter_t filter)
{
	uint8_t *y = output;
	uint8_t *u = y + 1;
	...
	return aipl_demosaic_yuv_packed(input, y, u, v, pitch, width, height, filter);
}

aipl_error_t aipl_demosaic_uyvy_default(const void *input, void *output, uint32_t pitch,
					uint32_t width, uint32_t height, aipl_bayer_filter_t filter)
{
	uint8_t *u = output;
	uint8_t *y = u + 1;
