...
.. code-block:: bash
   ...
   # GPIO
   west build -b alif_b1_dk/alif_b1_dk/ab1c1f4m51820ph0/rtss_he tests/drivers/gpio/ -DSNIPPET=alif-gpio

.. note::
   LPGPIO is not supported for ``alif_b1_dk/alif_b1_dk/ab1c1f4m51820ph0/rtss_he`` by the ``alif-lpgpio``
...
.. code-block:: bash
   ...
   # GPIO
   west build -b alif_e1c_dk/ae1c1f4051920hh/rtss_he tests/drivers/gpio/ -DSNIPPET=alif-gpio

Alif Ensemble E7 DK (RTSS-HE):
.. code-block:: bash

   # GPIO
   west build -b alif_e7_dk/ae722f80f55d5xx/rtss_he tests/drivers/gpio/ -DSNIPPET=alif-gpio

   # LPGPIO
   west build -b alif_e7_dk/ae722f80f55d5xx/rtss_he tests/drivers/gpio/ -DSNIPPET=alif-lpgpio

Alif Ensemble E7 DK (RTSS-HP):
.. code-block:: bash

   # GPIO
   west build -b alif_e7_dk/ae722f80f55d5xx/rtss_hp tests/drivers/gpio/ -DSNIPPET=alif-gpio
