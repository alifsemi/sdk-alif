...
static void dac_unsigned_binary_three_quarter_test(void)
{
	...
	TC_PRINT("=== DAC Unsigned Binary Three-Quarter (0x%x) Test ===\n",
		three_quarter);
	...
	TC_PRINT("DAC unsigned binary three-quarter test PASSED\n");
}
...
static void dac_unsigned_binary_step_values_test(void)
{
	...
	TC_PRINT("=== DAC Unsigned Binary Step Values Test ===\n");
	...
	TC_PRINT("DAC unsigned binary step values test PASSED\n");
}
...
static void dac_unsigned_binary_bit_pattern_test(void)
{
	...
	TC_PRINT("=== DAC Unsigned Binary Bit Pattern Test ===\n");
	...
	TC_PRINT("DAC unsigned binary bit pattern test PASSED\n");
}
...
static void dac_unsigned_binary_over_range_test(void)
{
	...
	TC_PRINT("=== DAC Unsigned Binary Over-Range Test ===\n");
	...
	TC_PRINT("DAC unsigned binary over-range test PASSED\n");
}
...
static void dac_twos_complement_zero_test(void)
{
	...
	TC_PRINT("=== DAC Two's Complement Zero Test ===\n");
	...
	TC_PRINT("DAC two's complement zero test PASSED\n");
}
...
static void dac_twos_complement_positive_test(void)
{
	...
	TC_PRINT("=== DAC Two's Complement Positive Values Test ===\n");
	...
	TC_PRINT("DAC two's complement positive test PASSED\n");
}
...
static void dac_twos_complement_negative_test(void)
{
	...
	TC_PRINT("=== DAC Two's Complement Negative Values Test ===\n");
	...
	TC_PRINT("DAC two's complement negative test PASSED\n");
}
...
static void dac_unsigned_monotonic_sweep_test(void)
{
	...
	TC_PRINT("=== DAC Unsigned Monotonic Sweep Test ===\n");
	...
	TC_PRINT("DAC unsigned monotonic sweep test PASSED (step=%u)\n", step);
}
...
{
	TC_PRINT("=== DAC Data Format Test Suite Setup ===\n");
...
{
	ARG_UNUSED(fixture);
	TC_PRINT("=== DAC Data Format Test Suite Teardown ===\n");
}
