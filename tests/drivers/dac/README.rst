...
.. code-block:: console
    ...
    west build -- -DDTC_OVERLAY_FILE=alif_dac0.overlay

    # Two's-complement mode: twos-complement tests enabled
    west build -- -DDTC_OVERLAY_FILE=alif_dac0_twoscomp.overlay

    # Maximum output current (1.5 mA) - HRM feature test
    west build -- -DDTC_OVERLAY_FILE=alif_dac0_max_current.overlay

    # Minimum output current (0 uA) - light load testing
    west build -- -DDTC_OVERLAY_FILE=alif_dac0_min_current.overlay
