...
.. code-block:: bash
   ...
   west build -b alif_e8_dk/ae822fa0e5597xx0/rtss_he tests/drivers/utimer_qdec \
     -DDTC_OVERLAY_FILE=tests/drivers/utimer_qdec/boards/alif_ensemble_qdec.overlay

**alif_e8_dk (rtss_hp):**

.. code-block:: bash

   west build -b alif_e8_dk/ae822fa0e5597xx0/rtss_hp tests/drivers/utimer_qdec \
     -DDTC_OVERLAY_FILE=tests/drivers/utimer_qdec/boards/alif_ensemble_qdec.overlay
...
.. code-block:: bash
   ...
   west build -b alif_e7_dk/ae722f80f55d5xx/rtss_he tests/drivers/utimer_qdec \
     -DDTC_OVERLAY_FILE=tests/drivers/utimer_qdec/boards/alif_ensemble_qdec.overlay
...
.. code-block:: bash
   ...
   west build -b alif_b1_dk/ab1c1f4m51820ph0/rtss_he tests/drivers/utimer_qdec \
     -DDTC_OVERLAY_FILE=tests/drivers/utimer_qdec/boards/alif_b1_dk_rtss_he.overlay

**alif_e1c_dk (rtss_he):**

.. code-block:: bash

   west build -b alif_e1c_dk/ae1c1f4051920hh/rtss_he tests/drivers/utimer_qdec \
     -DDTC_OVERLAY_FILE=tests/drivers/utimer_qdec/boards/alif_e1c_dk_rtss_he.overlay
