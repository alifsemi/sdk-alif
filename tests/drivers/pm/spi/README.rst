...
This test validates Zephyr power management (PM) state transitions on Alif RTSS
...
The test sets up two threads that continuously exchange data over an on-board SPI
