...
ZTEST(cmp_Basic, test_Comp_Hysteresis_Check)
{
	LOG_INF("CMP hysteresis level: %s", CMP_HYSTERESIS);

	if (!strcmp(CMP_HYSTERESIS, "42mV")) {
		LOG_INF("Hysteresis is 42mV");
	}
}

ZTEST(cmp_Basic, test_Comp_prescalar_min_max)
{
