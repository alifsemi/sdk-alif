...
.. code-block:: console
   ...
   west build -p always -b alif_e7_dk/ae711ca0e5597xx0/rtss_he tests/drivers/cmp -DDTC_OVERLAY_FILE="boards/alif_e7_dk_rtss_he.overlay"
...
*   **Hysteresis Overlays**:
    ...
    **Example** (E7 HE with 6mV hysteresis):
    ...
    .. code-block:: console
       ...
       west build -p always -b alif_e7_dk/ae711ca0e5597xx0/rtss_he tests/drivers/cmp \
