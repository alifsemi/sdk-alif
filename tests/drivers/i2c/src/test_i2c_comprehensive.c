...
{
	TC_PRINT("Running comprehensive master validation\n");
...
{
	TC_PRINT("Running comprehensive stress validation\n");
	const struct device *master = DEVICE_DT_GET(I2C_MASTER);
...
{
	TC_PRINT("Running comprehensive hardware-software co-validation\n");
	const struct device *master = DEVICE_DT_GET(I2C_MASTER);
...
{
	TC_PRINT("Running comprehensive regression validation\n");
	const struct device *master = DEVICE_DT_GET(I2C_MASTER);
